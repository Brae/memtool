...
DWORD WINAPI MyFunctionA(LPVOID lpParam) {
	time_t timer;
...
DWORD WINAPI MyFunctionB(LPVOID lpParam) {
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	hThreads[0] = CreateThread(NULL, 0, MyFunctionA, NULL, 0, &dwThreads[0]);
	hThreads[1] = CreateThread(NULL, 0, MyFunctionB, NULL, 0, &dwThreads[1]);
